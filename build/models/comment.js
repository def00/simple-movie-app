...
var _movie2 = _interopRequireDefault(require("./movie"));
...
_objection.Model.knex(_database["default"]);
...
function (_Model) {
  ...
  _createClass(Comment, [{
    ...
    value: function () {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", this.$relatedQuery('movie'));
      ...
      function movie() {
        return _movie.apply(this, arguments);
      }
